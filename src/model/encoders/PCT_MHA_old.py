...
class MHOA(nn.Module):
    ...
    def __init__(self, channels, num_heads=4):
        ...
        # 2. Proyecciones Multi-Head (Mantenemos tu lógica de pesos compartidos para Q y K)
        ...
        # 4. NUEVO: Feed-Forward Network (AQUÍ ESTÁ LA VERDADERA CAPACIDAD)
        # Expande la dimensión x2 o x4 y luego la vuelve a comprimir
        ffn_expansion = channels * 2
